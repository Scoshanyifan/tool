...
public interface CitizenMapper {
    ...
    @Insert(value = "insert into citizen (" + SQL + ") " +
            ...
            "  select * from citizen " +
            "  where id_card = #{idCard} and account = #{account})")
    int insertByCheck(@Param("idCard")String idCard, @Param("city")String city, @Param("account")String account, @Param("name")String name,
